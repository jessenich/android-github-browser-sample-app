...
package io.kplr.android.github.api

import androidx.arch.core.executor.testing.InstantTaskExecutorRule
import io.kplr.android.github.util.LiveDataCallAdapterFactory
...
class GithubServiceTest {
    ...
    fun getUser() {
        ...
        assertThat(yigit.blog, `is`("birbit.io"))
    }
    ...
    fun getRepos() {
        ...
        val repo2 = repos[1]
        assertThat(repo2.fullName, `is`("yigit/kplr-architecture"))
    }
    ...
    @Test
    fun search() {
        val next = """<https://api.github.io/search/repositories?q=foo&page=2>; rel="next""""
        val last = """<https://api.github.io/search/repositories?q=foo&page=34>; rel="last""""
        enqueueResponse(
            "search.json", mapOf(
                "link" to "$next,$last"
            )
